...
G005/G006 exactly; 26 rules total (18 before this change, 20 after — see
...
`W002` (witness coverage below the detected floor); 26 rules total (20
before this change; see the SpecKit-dialect change for the next
increment, to 26).
